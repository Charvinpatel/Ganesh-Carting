...
import {
  LayoutDashboard, Users, Truck, Route, Fuel, BarChart3, FileText,
  Settings, Menu, X, ChevronRight, Activity, TrendingUp, LogOut, CheckCircle, Layers, MapPin, Wallet
} from 'lucide-react';
...
const NAV_ADMIN = [
  ...
  { to: '/verify-trips', icon: CheckCircle, label: 'Drivers Trip' },
  { to: '/diesel', icon: Fuel, label: 'Diesel' },
  { to: '/upad', icon: Wallet, label: 'Upad' },
  { to: '/drivers', icon: Users, label: 'Drivers' },
  { to: '/vehicles', icon: Truck, label: 'Vehicles' },
  { to: '/soil', icon: Layers, label: 'Soil' },
