 ...
 *
 * Drop this file into  src/utils/api.js  in the Vite project.
 * Every function mirrors the zustand store actions so you can
 * swap them in gradually.
 *
 * Usage:
...
const api = { auth, drivers, vehicles, soilTypes, trips, diesel, dashboard, finance, reports };
export default api;
