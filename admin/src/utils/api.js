/**
 * api.js  —  TransportPro admin ↔ backend service
 *
...
export const trips = {
  getAll:  (filters = {}) => {
    // Strip empty/null/undefined values so they don't get sent as empty query params
...
const api = { auth, drivers, vehicles, soilTypes, trips, diesel, dashboard, finance, reports, driverTrips, upad, locations, bills };
export default api;
